...
For reports and XMLports, as on lists, you can set filters to limit which data to include in the report or XMLport, but you cannot sort and search.
...
### Fine-tuning the Search by using Filter criteria

You can make a more exact search by using filter operators, expressions and filter tokens. Unlike filtering, these are applied across all fields when used in the search box.
